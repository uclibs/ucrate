...
RSpec.describe WorkgroupsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested workgroup as @workgroup" do
      workgroup = Workgroup.create! valid_attributes
      get :show, params: {id: workgroup.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested workgroup as @workgroup" do
      workgroup = Workgroup.create! valid_attributes
      get :edit, params: {id: workgroup.to_param}, session: valid_session
      expect(assigns(:workgroup)).to eq(workgroup)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Workgroup" do
        expect {
          post :create, params: {workgroup: valid_attributes}, session: valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "assigns the requested workgroup as @workgroup" do
        workgroup = Workgroup.create! valid_attributes
        put :update, params: {id: workgroup.to_param, workgroup: valid_attributes}, session: valid_session
        expect(assigns(:workgroup)).to eq(workgroup)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested workgroup" do
      workgroup = Workgroup.create! valid_attributes
      expect {
        delete :destroy, params: {id: workgroup.to_param}, session: valid_session
      }.to change(Workgroup, :count).by(-1)
    end
    ...
    it "redirects to the workgroups list" do
      workgroup = Workgroup.create! valid_attributes
      delete :destroy, params: {id: workgroup.to_param}, session: valid_session
      expect(response).to redirect_to(workgroups_url)
    end
  end
