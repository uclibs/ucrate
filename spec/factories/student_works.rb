...
FactoryBot.define do
  factory :student_work, class: 'StudentWork' do
    transient do
      user { create(:user) }
    ...
    factory :student_work_with_one_child do
      before(:create) do |work, evaluator|
        work.ordered_members << create(:work, user: evaluator.user, title: ['A Contained Work'])
      end
    end

    factory :student_work_with_two_children do
      before(:create) do |work, evaluator|
    ...
    factory :student_work_with_representative_file do
      before(:create) do |work, evaluator|
    ...
    factory :student_work_with_file_and_work do
      before(:create) do |work, evaluator|
        work.ordered_members << create(:file_set, user: evaluator.user)
    ...
    factory :student_work_with_embargo_date do
      # build with defaults:
      ...
      factory :embargoed_student_work do
        after(:build) do |work, evaluator|
      ...
      factory :embargoed_student_work_with_files do
        after(:build) do |work, evaluator|
          if evaluator.with_embargo_attributes
            work.apply_embargo(evaluator.with_embargo_attributes[:embargo_date],
                               evaluator.with_embargo_attributes[:current_state],
    ...
    factory :student_work_with_lease_date do
      # build with defaults:
      ...
      factory :leased_student_work do
        after(:build) do |work, evaluator|
      ...
      factory :leased_student_work_with_files do
        after(:build) do |work, evaluator|
          if evaluator.with_lease_attributes
            work.apply_lease(evaluator.with_lease_attributes[:lease_date],
                             evaluator.with_lease_attributes[:current_state],
