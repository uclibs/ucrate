...
FactoryBot.define do
  factory :image, class: 'Image' do
    ...
    factory :image_with_ordered_files do
      before(:create) do |work, evaluator|
    ...
    factory :image_with_representative_file do
      before(:create) do |work, evaluator|
    ...
    factory :image_with_file_and_work do
      before(:create) do |work, evaluator|
        work.ordered_members << create(:file_set, user: evaluator.user)
    ...
    factory :image_with_lease_date do
      # build with defaults:
