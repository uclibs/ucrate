...
# Generated via
#  `rails generate hyrax:work Generic Work`
require 'rails_helper'
include Warden::Test::Helpers

# NOTE: If you generated more than one work, you have to set "js: true"
RSpec.describe 'Create a Generic Work', :feature, js: true do
  context 'a logged in user', :clean_repo do
    ...
    it do
      ...
      select license, from: "generic_work_license"
      ...
      expect(page).to have_field('generic_work_title', with: title)
      expect(page).to have_field('generic_work_creator', with: creator)
      expect(page).to have_field('generic_work_college', with: college)
      expect(page).to have_field('Program or Department', with: program)
      expect(page).to have_field('Description', with: description)
      expect(page).to have_select('generic_work_license', selected: license)
