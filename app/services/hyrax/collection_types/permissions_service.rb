...
module Hyrax
  module CollectionTypes
    ...
    # with Rails 6.  This class was copied over in its entirety and then modified because scholar
    # was not recognizing the non-overwritten original methods.
    class PermissionsService
      ...
      # changed from :user_groups which appears to be a typo
