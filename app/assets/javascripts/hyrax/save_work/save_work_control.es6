...
import { SafeFiles } from './safe_files'
...
export default class SaveWorkControl {
  ...
  activate() {
    ...
    this.safeFiles = new SafeFiles(this.form, () => this.formStateChanged())
    ...
    this.requiredSafe = new ChecklistItem(this.element.find('#required-safe'))
