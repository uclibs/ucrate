...
module Hyrax
  class EtdForm < Hyrax::Forms::WorkForm
    ...
    self.terms -= %i[rights_statement keyword source contributor based_near identifier resource_type publisher alternative_title abstract access_right rights_notes]
